...
namespace Chat.AuthServer.ModelConfigurations.Base
{
    public abstract class AuditableModelConfigurationBase<T> : IEntityTypeConfiguration<T> where T : Auditable
    {
        public void Configure(EntityTypeBuilder<T> builder)
        {
            ...
            builder.Property(x => x.UpdatedAt).IsRequired().HasConversion(v => v, v => DateTime.SpecifyKind((DateTime)v, DateTimeKind.Utc));
