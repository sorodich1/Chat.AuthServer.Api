...
namespace WebChatAPI.Middlewares
{
    public static class ApplicationBuilderExtensions
    {
        ...
        public static void UseETagger(this IApplicationBuilder application) => application.UseMiddleware<ETagMiddleware>();
    }
    ...
    public class ETagMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            using (var ms = new MemoryStream())
            {
                ...
                if (IsEtagSupported(response))
                {
                    ...
                    {
                        Program.Logger.Error($"Статус подключения {response.StatusCode}");
        ...
        public static bool IsEtagSupported(HttpResponse response)
        {
